...
function Presentation() {
  return (
        <div className={styles.containerPresentation} id='who_i_am'>  
            <Btn addStyle={styles.btnDescarga} props={'Descargar Cv'} link={'https://drive.google.com/file/d/1RcaSDZ7F18dFkqj0zZHZ-eH1tOcaKRoc/view?usp=sharing'} pagina={"_blank"}/>    
