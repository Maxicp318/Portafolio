...
function Presentation() {
  return (
        <div className={styles.containerPresentation} id='who_i_am'>  
            <Btn addStyle={styles.btnDescarga} props={'Descargar Cv'} link={'https://drive.google.com/file/d/1Z4Z8jBtQ6VvvNlPy1gVZoo_DNmNzbDku/view?usp=drivesdk'} pagina={"_blank"}/>    
            ...
            <article className={styles.containerText}>
                <p className={`animate__animated animate__fadeInDown who_I_am ${styles.textPresentation}`}>
                    ...
                    <br />Me destacó por mi empatia para formar buenas relaciones personales
                    ...
                    sumar experiencia para lograr ser un gran profesional en el mundo de la Programación. 
                </p>
            </article>
        </div>
    )  
